...
import { useFrame, ThreeElements, RootState } from '@react-three/fiber'
...
type ComputersProps = ThreeElements['group'] & {
  text: string
  monitorColor: string
  centerMonitorColor: string
  monitorGlow: number
  centerMonitorGlow: number
  shapeColor: string
  shapeType: string
  shapeScale: number
  rotate: boolean
  ...
  return (
    <group {...props} dispose={null}>
      ...
      <ScreenInteractive
        frame="Object_206"
        panel="Object_207"
        color={props.centerMonitorColor}
        glow={props.centerMonitorGlow}
        position={[0.27, 1.53, -2.61]}
        shapeColor={props.shapeColor}
        shapeType={props.shapeType}
        shapeScale={props.shapeScale}
        rotate={props.rotate}
        rotateSpeed={props.rotateSpeed}
        hoverEffect={props.hoverEffect}
        hoverColor={props.hoverColor}
      />
      <ScreenText frame="Object_209" panel="Object_210" y={5} text={props.text} color={props.monitorColor} glow={props.monitorGlow} position={[-1.43, 2.5, -1.8]} rotation={[0, 1, 0]} />
      <ScreenText invert frame="Object_212" panel="Object_213" x={-5} y={5} text={props.text} color={props.monitorColor} glow={props.monitorGlow} position={[-2.73, 0.63, -0.52]} rotation={[0, 1.09, 0]} />
      <ScreenText invert frame="Object_215" panel="Object_216" text={props.text} color={props.monitorColor} glow={props.monitorGlow} position={[1.84, 0.38, -1.77]} rotation={[0, -Math.PI / 9, 0]} />
      <ScreenText invert frame="Object_218" panel="Object_219" x={-5} text={props.text} color={props.monitorColor} glow={props.monitorGlow} position={[3.11, 2.15, -0.18]} rotation={[0, -0.79, 0]} scale={0.81} />
      <ScreenText frame="Object_221" panel="Object_222" y={5} text={props.text} color={props.monitorColor} glow={props.monitorGlow} position={[-3.42, 3.06, 1.3]} rotation={[0, 1.22, 0]} scale={0.9} />
      <ScreenText invert frame="Object_224" panel="Object_225" text={props.text} color={props.monitorColor} glow={props.monitorGlow} position={[-3.9, 4.29, -2.64]} rotation={[0, 0.54, 0]} />
      <ScreenText frame="Object_227" panel="Object_228" text={props.text} color={props.monitorColor} glow={props.monitorGlow} position={[0.96, 4.28, -4.2]} rotation={[0, -0.65, 0]} />
      <ScreenText frame="Object_230" panel="Object_231" text={props.text} color={props.monitorColor} glow={props.monitorGlow} position={[4.68, 4.29, -1.56]} rotation={[0, -Math.PI / 3, 0]} />
      <Leds />
    </group>
  )
}
...
type ScreenTextProps = ThreeElements['group'] & {
  invert?: boolean
  x?: number
  y?: number
  text: string
...
function ScreenText({ invert, x = 0, y = 1.2, text, color, glow, frame, panel, ...props }: ScreenTextProps) {
...
type ScreenInteractiveProps = ThreeElements['group'] & {
  color: string
  glow: number
  frame: string
  panel: string
...
function ScreenInteractive({ color, glow, frame, panel, shapeColor, shapeType, shapeScale, rotate, rotateSpeed, hoverEffect, hoverColor, ...props }: ScreenInteractiveProps) {
  return (
    <Screen frame={frame} panel={panel} {...props}>
      <PerspectiveCamera makeDefault manual aspect={1 / 1} position={[0, 0, 10]} />
      <color attach="background" args={[color]} />
      <ambientLight intensity={Math.PI / 2} />
      <pointLight decay={0} position={[10, 10, 10]} intensity={glow} />
